...
class ReactiveLabel(StateAwareWidget):
    ...
    format_func: reactive[Optional[Callable]] = reactive(None)
    state_key: reactive[Optional[str]] = reactive(None)
    ...
    def watch_format_func(self, func: Optional[Callable]) -> None:
